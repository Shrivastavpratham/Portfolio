...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_dslm2m1', 'template_yyl2o6d', form.current, 'eJp5x8UluOCABWb2S')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">prathamshrivastav5@gmail.com</span>
                        
                        <a href="mailto:prathamshrivastav5@gmail.com" className="contact__button">
                            Write Me{" "} 
